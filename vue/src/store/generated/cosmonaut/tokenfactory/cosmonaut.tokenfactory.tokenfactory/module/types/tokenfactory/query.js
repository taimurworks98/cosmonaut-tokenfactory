...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("cosmonaut.tokenfactory.tokenfactory.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Denom(request) {
        const data = QueryGetDenomRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.tokenfactory.tokenfactory.Query", "Denom", data);
    ...
    DenomAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.tokenfactory.tokenfactory.Query", "DenomAll", data);
